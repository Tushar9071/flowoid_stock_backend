      ...
      schemas: {
        ...
        SaveWhatsappConfigRequest: {
          ...
          properties: {
            ...
            invoiceTemplateName: { type: "string", example: "invoice" },
        ...
        SubmitWhatsappTemplateRequest: {
          ...
          properties: {
            name: { type: "string", pattern: "^[a-z][a-z0-9_]*$", example: "invoice" },
            language: { type: "string", default: "en_US", example: "en_US" },
            category: {
              type: "string",
        ...
        WhatsappConfig: {
          ...
          properties: {
            ...
            invoiceTemplateName: { type: "string", nullable: true, example: "invoice" },
        ...
        WhatsappMessageLog: {
          ...
          properties: {
            ...
            templateName: { type: "string", nullable: true, example: "invoice" },
